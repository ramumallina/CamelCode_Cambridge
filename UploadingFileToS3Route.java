...
@Component
public class UploadingFileToS3Route extends RouteBuilder{

  private Logger logger = LoggerFactory.getLogger(UploadingFileToS3Route.class);
